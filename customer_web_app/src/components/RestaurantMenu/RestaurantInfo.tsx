...
const RestaurantInfo = ({ resMainInfo }: { resMainInfo: ResMainInfo }) => {
      ...
      <div className="flex" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse text-color-5">
          <li className="inline-flex items-center">
            <Link href="/" className="inline-flex items-center text-xs font-medium">
              {t("Home")}
            </Link>
          </li>
          <li>
            <div className="flex items-center">
              <BreadcrumbArrow />
              <Link href="/" className="ms-1 text-xs font-medium">
                {city}
              </Link>
            </div>
          </li>
