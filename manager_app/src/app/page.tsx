...
import { ArrowDownIcon, ArrowUpIcon, ChefHat, DollarSign, ShoppingBag, Star, Users, CreditCard, Globe, XCircle, MapPin } from "lucide-react"
      ...
      <Tabs defaultValue="overview" className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <ChartContainer config={{
                ...
                discounts: { label: "Discounts", color: "hsl(var(--chart-2))" },
                fees: { label: "Delivery Fees", color: "hsl(var(--chart-3))" },
              }} className="h-[200px]">
        ...
        <TabsContent value="menu" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <ChartContainer config={{
                quantity: { label: "Quantity Sold", color: "hsl(var(--chart-1))" },
              }} className="h-[200px]">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <TabsContent value="orders" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <ChartContainer config={{
                preparation: { label: "Preparation Time", color: "hsl(var(--chart-1))" },
                delivery: { label: "Delivery Time", color: "hsl(var(--chart-2))" },
                completion: { label: "Total Time", color: "hsl(var(--chart-3))" },
              }} className="h-[200px]">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={orderDurationData}>
                    ...
                    <YAxis />
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <Line type="monotone" dataKey="preparation" stroke="var(--color-preparation)" />
          ...
          <Card>
            ...
            <CardContent>
              <ChartContainer config={{
                cancellations: { label: "Cancellations", color: "hsl(var(--chart-1))" },
              }} className="h-[200px]">
                <ResponsiveContainer width="100%" height="100%">
