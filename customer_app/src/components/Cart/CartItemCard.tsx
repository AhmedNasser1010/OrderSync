...
const CartItemCard = ({
  ...
  const percentOff =
    discountIncluded && price > 0 && finalPrice < price
      ...
      : 0;
  const hasDiscountMsg = Boolean(discountIncluded && discountMsg);
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <button
            ...
            disabled={disabled}
            aria-label={t("Remove")}
            className="flex items-center gap-1.5 rounded-full px-3 py-2 text-sm font-ProximaNovaMed text-color-5 transition-colors hover:bg-red-50 hover:text-red-500 disabled:pointer-events-none disabled:opacity-40 dark:hover:bg-red-950 dark:hover:text-red-400 cursor-pointer"
          >
