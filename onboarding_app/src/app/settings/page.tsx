...
export default function SettingsPage() {
  ...
  const feesPerKm = deliveryFeesPerKm ?? data?.deliveryFeesPerKm ?? DEFAULT_DELIVERY_FEES_PER_KM;
  const minFees = minDeliveryFees ?? data?.minDeliveryFees ?? DEFAULT_MIN_DELIVERY_FEES;
