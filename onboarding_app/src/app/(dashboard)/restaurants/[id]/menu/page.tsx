...
import { Plus, Cloud, UtensilsCrossed, Percent, Trash2, Power, Loader2, ChevronLeft } from "lucide-react";
...
export default function MenuManagementPage() {
  ...
  const {
    ...
    moveCategory,
    moveItem,
  } = useMenuData(id, restaurant?.partnerUid);
  ...
  return (
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground truncate">
                {restaurant?.profile.name ?? "Manage categories, items, and promotions"}
              </p>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <ActionsMenu
                  items={[
                    ...
                    {
                      key: "toggleActive",
                      label: discount.active ? "Disable Discount" : "Enable Discount",
    ...
    <DiscountDialog
      key={
        discountDialogOpen
          ? (editingDiscount?.id ?? "new-discount")
          : "closed"
      }
