...
interface MenuSliceState extends MenuData {
  syncedSnapshot: MenuData | null;
}
...
export const menuSlice = createSlice({
  ...
  initialState,
  reducers: {
    addMenu: (state, { payload }: PayloadAction<MenuData>) => ({
      ...payload,
      syncedSnapshot: state.syncedSnapshot,
    }),
    clearMenu: () => initialState,
    setSyncedSnapshot: (state, { payload }: PayloadAction<MenuData>) => {
      state.syncedSnapshot = payload;
    },
